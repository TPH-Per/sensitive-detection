...
- `hobbies` (String, _Optional_): Sở thích cá nhân.
- `school` (String, _Optional_): Trường học/Nơi đào tạo.
...
- `id` (String, **Required**): Document ID.
- `authorId` (String, **Required**).
- `type` (String Enum, **Required**): `"regular"`, `"avatar_update"`, `"cover_update"`, `"shared"`. Mặc định `"regular"`.
- `originalPostId` (String, _Optional_): Bắt buộc có nếu type là `"shared"`. Nối tới ID của bài viết gốc.
